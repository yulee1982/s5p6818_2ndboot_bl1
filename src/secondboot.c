...
//--------------------------------------------------------------------------
	...
	if (Result) {
		...
		SYSMSG(" Test ddr3!\r\n");
		WriteIO32(0x80000000, 1);
		SYSMSG(" ddr3 addr 0x8000000 write 1!\r\n");
		WriteIO32(0x80000004, 2);
		SYSMSG(" ddr3 addr 0x8000004 write 2!\r\n");	
		WriteIO32(0x80000008, 3);
		SYSMSG(" ddr3 addr 0x8000008 write 3!\r\n");
		temp = ReadIO32(0x80000000);
		SYSMSG("Data1 of 0x80000000: 0x%08X \r\n", temp);
		temp = ReadIO32(0x80000004);
		SYSMSG("Data1 of 0x80000004: 0x%08X \r\n", temp);
		temp = ReadIO32(0x80000008);
		SYSMSG("Data1 of 0x80000008: 0x%08X \r\n", temp);
		*/
#ifdef aarch64
	    SwitchToEL2();
#endif
